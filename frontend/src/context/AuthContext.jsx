...
export function AuthProvider({ children }) {
  ...
  const mettreAJourUtilisateur = (champs) => {
    setUtilisateur(prev => {
      const updated = { ...prev, ...champs }
      localStorage.setItem("aa_user", JSON.stringify(updated))
      return updated
    })
  }

  return (
    <AuthContext.Provider value={{ utilisateur, connexion, deconnexion, chargement, mettreAJourUtilisateur }}>
      {children}
